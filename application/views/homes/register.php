                    ...
                    <div class="form-bottom">
                        <form role="form" action="" method="post" class="login-form" data-parsley-validate>
                            <div class="form-group">
                                <label class="sr-only" for="form-employeename">Employee Name</label>
                                <input type="text" name="form-employeename" placeholder="EMPLOYEE NAME" class="form-username form-control" id="form-username" data-parsley-required>
                            </div>
                            <div class="form-group">

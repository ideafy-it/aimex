...
<html lang="en">
    ...
    <body>
        ...
        <strong><h4><span class="glyphicon glyphicon-book"></span>  
        ADDITIONAL LOAN</h4></strong>
         ...
         <div class="clientinfo">
           ...
           <div id="show_extension_loandetails">    
                <strong><h4>INPUT LOAN DETAILS</h4></strong>

                <div id="extension_loandetails">
                    <div id="loandetails_left">
                       PENSION AMOUNT:  <input type="text" id="pension_amount" name="pension_amount" placeholder="60,000"><br>
                       AMOUNT TO ADD:  <input type="text" id="add_amount" name="add_amount" placeholder="2000"><br>
                       SUKLI FROM EXISTING LOAN:  <input type="text" id="sukli" name="sukli" placeholder="5000"><br>
                    </div>                     
        ...
        <div id="newclientapp_submit">
          <button type="button" class="btn btn-primary" id="transact-submit" type="submit">PROCEED</button>
        </div>

...
<div class="container">
  ...
  <div id="manage-navbar">
    <ul class="nav nav-tabs">
      <li class="active">
        <a href="transactiontype.html">
          <span class="glyphicon glyphicon-envelope"></span> APPLY</a>
      </li>
      <li class="dropdown">
        <a href="#">
      ...
      <li>
        <a href="transactionsummary.html">
          <span class="glyphicon glyphicon-edit"></span> REPORT</a>
      </li>
      <li>
        <a href="timelog.html">
          <span class="glyphicon glyphicon-calendar"></span> TIME LOG</a>
      </li>
    </ul>
  </div>
  ...
  <div class="clientinfo">
    <div id="clientinfo-left">
      ...
      <div class="form-group">
        <p>
          ...
          <br> LOAN TYPE: SSS
          <br> LOAN AMOUNT: 60,000
          <br> PAYMENT SCHEDULE: MONTHLY
          <br>
        </p>
      </div>
      </div>
      ...
      <div class="form-group">
        PENSION TERMS (IN MONTHS): 12
        <br> RELEASE DATE: 03/17/2017
        <br> EFFECTIVE DATE: 03/17/2017
        <br> REFERENCE CHEQUE: 81238174
      </div>
    </div>
  </div>
    ...
    <div id="show_loan_breakdown">
      <strong>
        <h4>LOANS BREAKDOWN</h4>
      </strong>
      <div id="loan_breakdown">
        <div id="textbox">
          <p class="alignleft">
            <strong>LOANS RECEIVABLE</strong>
          </p>

...
<html lang="en">
    ...
    <body>
         ...
         <div class="top-nav">
            ...
            <div id="manage-navbar">
                    <ul class="nav nav-tabs">
                      ...
                      <li class="active"><a href="transactionsummary.html"><span class="glyphicon glyphicon-edit"></span>  REPORT</a></li>
        ...
        TRANSACTIONS SUMMARY</h4></strong>
            ...
            <div id="client-transactions">
              <table id="client-transactions-table">
                <tr>
                  ...
                  <th>REMAINING BALANCE <span class="glyphicon glyphicon-sort"></span></th>
